/* * © Copyright 2022 · Willem Vervuurt, Studio Delfuego * * You can modify, use
and distribute this package under one of two licenses: * 1. GNU AGPLv3 * 2. A
perpetual, non-revocable and 100% free (as in beer) do-what-you-want * license
...
export default {
  ...
  methods: {
    ...
    reload() {
      ...
      Nova.request()
        .get(
          "/nova-vendor/wdelfuego/nova-calendar/calendar-data/" +
            vue.year +
            "/" +
            vue.month
        )
